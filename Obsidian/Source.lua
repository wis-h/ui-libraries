-- We'd recommend using their official source incase they have any updates that haven't been cloned here yet. :)
-- https://github.com/deividcomsono/Obsidian/tree/main
